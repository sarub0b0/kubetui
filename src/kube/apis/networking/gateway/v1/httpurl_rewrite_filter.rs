// Generated from definition io.k8s.networking.gateway.v1.HTTPURLRewriteFilter
...
impl crate::kube::apis::DeepMerge for HTTPURLRewriteFilter {
...
impl<'de> crate::kube::apis::serde::Deserialize<'de> for HTTPURLRewriteFilter {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::kube::apis::serde::Deserializer<'de> {
        ...
        impl<'de> crate::kube::apis::serde::de::Visitor<'de> for Visitor {
            type Value = HTTPURLRewriteFilter;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("HTTPURLRewriteFilter")
            }
...
impl crate::kube::apis::serde::Serialize for HTTPURLRewriteFilter {
...
impl crate::kube::apis::schemars::JsonSchema for HTTPURLRewriteFilter {
    fn schema_name() -> String {
        "io.k8s.networking.gateway.v1.HTTPURLRewriteFilter".to_owned()
    }
    ...
    fn json_schema(__gen: &mut crate::kube::apis::schemars::gen::SchemaGenerator) -> crate::kube::apis::schemars::schema::Schema {
        crate::kube::apis::schemars::schema::Schema::Object(crate::kube::apis::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::kube::apis::schemars::schema::Metadata {
                description: Some("URLRewrite defines a schema for a filter that modifies a request during forwarding. \n Support: Extended".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::kube::apis::schemars::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::kube::apis::schemars::schema::Schema::Object(crate::kube::apis::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::kube::apis::schemars::schema::Metadata {
                                description: Some("Hostname is the value to be used to replace the Host header value during forwarding. \n Support: Extended".to_owned()),
                                ..Default::default()
                            })),
