// Generated from definition io.k8s.networking.gateway.v1.GatewayStatusAddress
...
impl crate::kube::apis::DeepMerge for GatewayStatusAddress {
...
impl<'de> crate::kube::apis::serde::Deserialize<'de> for GatewayStatusAddress {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::kube::apis::serde::Deserializer<'de> {
        ...
        impl<'de> crate::kube::apis::serde::de::Visitor<'de> for Visitor {
            type Value = GatewayStatusAddress;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("GatewayStatusAddress")
            }
...
impl crate::kube::apis::serde::Serialize for GatewayStatusAddress {
...
impl crate::kube::apis::schemars::JsonSchema for GatewayStatusAddress {
    fn schema_name() -> String {
        "io.k8s.networking.gateway.v1.GatewayStatusAddress".to_owned()
    }
    ...
    fn json_schema(__gen: &mut crate::kube::apis::schemars::gen::SchemaGenerator) -> crate::kube::apis::schemars::schema::Schema {
        crate::kube::apis::schemars::schema::Schema::Object(crate::kube::apis::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::kube::apis::schemars::schema::Metadata {
                description: Some("GatewayStatusAddress describes a network address that is bound to a Gateway.".to_owned()),
                ..Default::default()
            })),
