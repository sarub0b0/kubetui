...
use crate::{
    features::{
        component_id::{
            CONFIG_RAW_DATA_WIDGET_ID, EVENT_WIDGET_ID, LIST_WIDGET_ID,
            MULTIPLE_NAMESPACES_POPUP_ID, NETWORK_DESCRIPTION_WIDGET_ID, POD_LOG_QUERY_WIDGET_ID,
            POD_LOG_WIDGET_ID, SINGLE_NAMESPACE_POPUP_ID, YAML_WIDGET_ID,
        },
